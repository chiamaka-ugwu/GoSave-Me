                ...
                <div className="right">
                    ...
                    <div className="hosp-details hosp-details2">
                        <div className="details1">
                            ...
                            <input type="text" name='hospital-email' placeholder='Hospital Email Address' 
                                value={user.data.hospitalEmail}
                                readOnly 
                            />
                            
                            <label for="hospital-phone">Hospital Phone number</label>
                            <input type="tel" name='hospital-phone' placeholder='Hospital Phone number'
                                value={user.data.hospitalPhone}
                                readOnly
                            />

                            <label for="person-email">Person of contact Email Address</label>
                            <input type="email" name='person-email' placeholder='Person of contact Email Address' 
                                value={user.data.directorEmail}
                                readOnly 
                            />

                            <label for="person-phone">Person of contact Phone Number</label>
                            <input type="tel" name='person-phone' placeholder='Person of contact Phone Number' 
                        ...
                        <label for="account-name">Website</label>
                            <input type="url" name='website' placeholder='Organisation Website  URL' 
                            ...
                            <input type="text" name='Instagram handle' placeholder='Instagram handle' 
                                value={user.data.instagram}
                                readOnly 
                            />

                            <label for="Twitter handle">Twitter handle</label>
                            <input type="text" name='Twitter handle' placeholder='Twitter handle' 
