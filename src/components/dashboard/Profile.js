            ...
            <div className="dashboard">
                ...
                <div className="right">
                    ...
                    <div className="info-section">
                        ...
                        <p>Hospital name, bank details, licence and registeration 
                            number can not be changed, if you would like to update your details kindly 
                    ...
                    <div className="hosp-logo">
                        ...
                        <div className="logo-cont">
                            ...
                            <div className="logo-btns">
                                <Button btnName='Change Logo' btnClass='change-logo' />
                                <p className='delete'>
                                    <img src={bin} alt="bin" />
                    ...
                    <div className="hosp-details">
                        <div className="details1">
                            ...
                            <input type="tel" name='CAC Reg No.' placeholder='CAC Reg No.' 
                                value={user.data.CACRegNo}
                                readOnly 
                            />

                            <label for="Licence No.">Licence No.</label>
                            <input type="tel" name='Licence No.' placeholder='Licence No.' 
                        ...
                        <label for="account-name">Account Name</label>
                            <input type="text" name='account-name' placeholder='Hospital Name' 
