      ...
      <div className="dashboard admin">
        <div className="left">
          <div className="dashboard-links admin-links">
            ...
            <p className="dashboard-link link-active admin-link">Requests</p>
            <p
              onClick={() => {
                setPage(4);
              }}
        ...
        <div className="right">
          <h3 className="db-h3 fund-h3">Fund Requests</h3>
          ...
          <h3 className="db-h3 sign-h3 fund-h3">Sign Up Requests</h3>
          <div className="table-container table-cont">
            <div className="table-box">
              <h4>Full name of the hospital will be here</h4>
              <div className="box-btns">
